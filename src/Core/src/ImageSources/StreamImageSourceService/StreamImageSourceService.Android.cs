...
namespace Microsoft.Maui
{
	public partial class StreamImageSourceService
	{
		...
		public async Task<IImageSourceServiceResult<ResourceOrDrawable>?> GetDrawableAsync(IStreamImageSource imageSource, Context context, CancellationToken cancellationToken = default)
		{
